...
EVISITOR_DEFAULT_ARRIVAL_ORGANISATION = os.getenv("EVISITOR_DEFAULT_ARRIVAL_ORGANISATION", "O")
EVISITOR_DEFAULT_OFFERED_SERVICE_TYPE = os.getenv(
    "EVISITOR_DEFAULT_OFFERED_SERVICE_TYPE",
    "noćenje",
)
EVISITOR_DEFAULT_PAYMENT_CATEGORY = os.getenv("EVISITOR_DEFAULT_PAYMENT_CATEGORY", "11")
