...
# eVisitor (HR tourist registration API)
EVISITOR_ENABLED = env_bool("EVISITOR_ENABLED", default=False)
EVISITOR_ENV = os.getenv("EVISITOR_ENV", "test").strip().lower()
EVISITOR_BASE_URL = os.getenv(
    "EVISITOR_BASE_URL",
    "https://www.evisitor.hr/testApi",
).rstrip("/")
EVISITOR_USERNAME = os.getenv("EVISITOR_USERNAME", "")
EVISITOR_PASSWORD = os.getenv("EVISITOR_PASSWORD", "")
EVISITOR_API_KEY = os.getenv("EVISITOR_API_KEY", "")
EVISITOR_FACILITY_CODE = os.getenv("EVISITOR_FACILITY_CODE", "")
# CodeMI iz ArrivalOrganisationLookup (npr. I = Osobno, A = Agencijski).
EVISITOR_DEFAULT_ARRIVAL_ORGANISATION = os.getenv("EVISITOR_DEFAULT_ARRIVAL_ORGANISATION", "I")
EVISITOR_DEFAULT_OFFERED_SERVICE_TYPE = os.getenv(
    "EVISITOR_DEFAULT_OFFERED_SERVICE_TYPE",
    "Noćenje",
)
# 14 = turist u ugostiteljskom objektu (TTPaymentCategoryLookup).
EVISITOR_DEFAULT_PAYMENT_CATEGORY = os.getenv("EVISITOR_DEFAULT_PAYMENT_CATEGORY", "14")
